...
import { googleSignIn, emailSignIn, emailSignUp, sendOTP, verifyOTPAndRegister, firebaseAuth } from '../controllers/authController';
...
router.post('/auth/firebase', firebaseAuth);           // Firebase auth endpoint (takes idToken)
